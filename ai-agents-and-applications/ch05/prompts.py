...
How to select the correct assistant: you must select the relevant assistant depending on the topic of the question,
...
Write {num_search_queries} web search queries to gather as much information as possible on the following question: {user_question}.
...
WEB_SEARCH_PROMPT_TEMPLATE = PromptTemplate.from_template(WEB_SEARCH_INSTRUCTIONS)
...
You are evaluating whether the following research summary adequately answers the question.
